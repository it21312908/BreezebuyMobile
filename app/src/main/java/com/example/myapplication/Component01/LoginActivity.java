                ...
                public void onResponse(Call call, Response response) throws IOException {
                    if (response.isSuccessful()) {
                        try {
                            ...
                            boolean isCustomer = Arrays.stream(roles).anyMatch(role -> role.equals("Customer"));
                            ...
                            runOnUiThread(() -> {
                                if (isCustomer) {
                                    ...
                                    Toast.makeText(LoginActivity.this, "You do not have the required permissions to log in.", Toast.LENGTH_SHORT).show();
                                }
                            });
